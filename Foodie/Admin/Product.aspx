                                    ...
                                    <div class="row">
                                        <div class="col-sm-6 col-md-4 col-lg-4">
                                            ...
                                            <div class="form-group">
                                             ...
                                             <div class="form-group">
                                                ...
                                                <div>
                                                    ...
                                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ErrorMessage="Quantity not be non negative" 
                                            ...
                                            <div class="form-group">  
                                                ...
                                                <div>  
                                                    <asp:DropDownList ID="ddCategories" runat="server" CssClass="form-control"
                                                    ...
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server"  
                                                        ...
                                                        SetFocusOnError="true" ControlToValidate="ddCategories" InitialValue="0">  
                                            ...
                                            <div class="card-block table-border-style">  
                                                <div class="table-responsive">  
                                                    <asp:Repeater ID="rProduct" runat="server" OnItemCommand="rProduct_ItemCommand"
                                                        ...
                                                        <HeaderTemplate>
                                                            <table id="Table" class="table data-table-export table-hover nowrap">
                                                                <thead>
                                                                    <tr>
                                                                        <th class="table-plus">Name</t>
                                                                        <th>Image</th>
                                                                        <th>Price($)</th>
                                                                        <th>Quantity</th>
                                                                        <th>Category</th>
                                                        ...
                                                        <ItemTemplate>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <asp:LinkButton ID="lnkDelete" Text="Delete" CssClass="badge bg-danger" runat="server"
