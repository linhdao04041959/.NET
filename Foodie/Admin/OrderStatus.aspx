                                                    ...
                                                    <asp:Repeater ID="rOderStatus" runat="server" OnItemCommand="rOderStatus_ItemCommand">
                                                        <HeaderTemplate>
                                                            <table id="categoryTable" class="table data-table-export table-hover nowrap">
                                                                <thead>
                                                                    <tr>
                                                                        <th class="table-plus">Order No.</t>
                                                                        <th>Order Date</th>
                                                                        <th>Status</th>
                                                                        <th>Product Name</th>
                                                                        <th>Total Price</th>
                                                        ...
                                                        <ItemTemplate>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:LinkButton ID="lnkEdit" runat="server" CssClass="badge badge-primary" Text="Edit" 
                                                                            CommandName="edit" CommandArgument='<%# Eval("OrderDetailsId") %>'>
                                                                                <i class="ti-pencil"></i>
                                                                        </asp:LinkButton>
                                                                    </td>
                                                                </tr>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div>
                                                            ...
                                                            <asp:RequiredFieldValidator ID="rfvDdlOrderStatus" runat="server" ForeColor="Red" ControlToValidate="ddlOrderStatus" 
                                                                ErrorMessage="Order status is required" SetFocusOnError="true" Display="Dynamic" InitiaValue=0></asp:RequiredFieldValidator>
