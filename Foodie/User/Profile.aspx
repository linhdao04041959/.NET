...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <%
        string imageUrl = Session["imageUrl"] != null ? Session["imageUrl"].ToString() : "../Images/default-image.png";
    %>
                            ...
                            <div class="card-title mb-4">
                                <div calss="d-flex justify-content-start">
                                    ...
                                    <div class="userData ml-3">
                                        ...
                                        <h6 class="d-block">
                                            <a href="javascript:void(0)">
                                                <asp:Label ID="lblCreateDate" runat="server" ToolTip="Account Create On">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <ul class="nav nav-tabs mb-4" id="myTab" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link text-info" id="basicInfor-tab" data-toggle="tab" href="#basicInfo" role="tab"
